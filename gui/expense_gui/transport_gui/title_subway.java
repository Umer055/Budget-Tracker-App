...
public class title_subway extends JFrame {
    private Container c;
    ...
    public class MyActionListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            if (e.getActionCommand().equals("Submit")) {
                ...
                Subway s1 = new Subway(new Date(selected_day, selected_month, selected_year),
                        Integer.parseInt(money.getText()), description.getText());
                transport t = new transport();
                t.addSubway(s1);

                transport.writeToFile(t);

                JOptionPane.showMessageDialog(new JFrame(), "Submitted");
                dispose();

                transport_frame transportFrame = new transport_frame();
