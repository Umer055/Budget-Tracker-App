...
public class title_lunch extends JFrame {
    private Container c;
    ...
    public class MyActionListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            if (e.getActionCommand().equals("Submit")) {
                ...
                lunch l1 = new lunch(new Date(selected_day, selected_month, selected_year), Integer.parseInt(money.getText()), description.getText());
                food f = new food();
                f.addLunch(l1);
                food.writeToFile(f);
