...
public class title_dinner extends JFrame {
    private Container c;
    ...
    public class MyActionListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            if (e.getActionCommand().equals("Submit")) {
                ...
                dinner d1 = new dinner(new Date(selected_day, selected_month, selected_year), Integer.parseInt(money.getText()), description.getText());
                food f = new food();
                f.addDinner(d1);
            ...
            food_frame foodFrame = new food_frame();
