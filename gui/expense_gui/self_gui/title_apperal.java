...
public class title_apperal extends JFrame {
    private Container c;
    ...
    public class MyActionListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            if (e.getActionCommand().equals("Submit")) {
                ...
                Apperal a1 = new Apperal(new Date(selected_day, selected_month, selected_year), Integer.parseInt(money.getText()), description.getText());
                self s = new self();
                s.addApperal(a1);
                ...
                self_frame selfFrame = new self_frame();
